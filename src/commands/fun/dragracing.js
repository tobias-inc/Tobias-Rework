  ...
  run ({ t, message, channel, author }, user) {
    ...
    return channel.send(
      embed
        ...
        .addField(t('commands:dragracing.challenger'), t('commands:dragracing.maked', { action: corrida, author: user.username }))
        .addField(t('commands:dragracing.challenged'), t('commands:dragracing.maked', { action: corrida2, author: author.username }))
    )
  }
}