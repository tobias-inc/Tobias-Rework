...
const { Command, Emojis, Constants, TobiasEmbed } = require('../..')
          ...
          return initializeCollector
            .on('collect', async r => {
              if (
                ...
                await msg.reactions.removeAll().catch(() => { r.remove(this.client.user.id) })
              }
